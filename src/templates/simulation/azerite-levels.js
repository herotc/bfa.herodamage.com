...
class AzeriteLevelsSimulationTemplate extends React.Component {
  componentDidMount () {
    ...
    azeriteLevelsInit(`${reportsPath}${name}`, 'Test', templateDPS)
      ...
      <div>
        ...
        <p><Trans>In order to compare azerite powers with this chart, look for the end of the bars corresponding to the
          ...
          simulations are based on predefined gear sets instead of your own, after all. This means data shown here <b>depends
            heavily</b> on the used profile with its talents and is rather giving an outlook. If your
...
export default withI18n()(withStyles(styles)(AzeriteLevelsSimulationTemplate))

export const query = graphql`
  query AzeriteLevelsSimulation($lang: String!, $spec: String!, $simulationType: String!, $tier: String!, $variation: String!) {
    site {
      siteMetadata {
        reportsPath
      }
