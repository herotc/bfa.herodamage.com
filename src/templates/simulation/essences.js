...
const EssenceSimulationTemplate = (props) => (
  <StackedChartLayout {...props} chartTitle="Azerite Essences % DPS Gain per Rank">
    <div>
      <p><Trans>Here, you can compare expected DPS increase from azerite essences.</Trans></p>
      <p><Trans>In order to compare essences with this chart, look for the end of the bars corresponding to the
        rank of interest. However, you should <b>simulate your own character</b> to find your best setup. These
...
EssenceSimulationTemplate.propTypes = {
  data: PropTypes.object.isRequired,
  i18nPlugin: PropTypes.object
}

export default EssenceSimulationTemplate

export const query = graphql`
  query EssenceSimulation($lang: String!, $wowClass: String!, $simulationType: String!, $fightStyle: String!, $tier: String!, $spec: String!, $variation: String!) {
